...
const uint32_t TableStruct_myMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::MyMessage, age_),
  PROTOBUF_FIELD_OFFSET(::MyMessage, sex_),
  PROTOBUF_FIELD_OFFSET(::MyMessage, info_),
  PROTOBUF_FIELD_OFFSET(::MyMessage, phone_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_myMessage_2eproto = {
  false, false, 107, descriptor_table_protodef_myMessage_2eproto, "myMessage.proto", 
  &descriptor_table_myMessage_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_myMessage_2eproto::offsets,
  file_level_metadata_myMessage_2eproto, file_level_enum_descriptors_myMessage_2eproto, file_level_service_descriptors_myMessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_myMessage_2eproto_getter() {
  return &descriptor_table_myMessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_myMessage_2eproto(&descriptor_table_myMessage_2eproto);
...
MyMessage::MyMessage(const MyMessage& from)
  ...
  ::memcpy(&name_, &from.name_,
    ...
    reinterpret_cast<char*>(&name_)) + sizeof(sex_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "MyMessage.info"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_phone(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 40) {
          _internal_add_phone(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MyMessage::_InternalSerialize(
  ...
  // repeated int32 phone = 5;
  {
    int byte_size = _phone_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          5, _internal_phone(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:MyMessage)
  ...
  // repeated int32 phone = 5;
  {
    ...
    _phone_cached_byte_size_.store(cached_size,
